...
b = [0.019, 0.021, 0.023, 0.025, 0.027, 0.029, 0.031]
...
for i = 1: length(b)
    ...
    out_path = "$(@__DIR__)/plots/$(project)/$(FILE)/"
    ...
    # plot the theoretical nucleation size for constant b
    ...
    # 
    data_path = "$(@__DIR__)/data/$(project)/$(FILE)/"
