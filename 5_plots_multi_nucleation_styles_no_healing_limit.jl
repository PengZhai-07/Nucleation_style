...
for index = EX                 # normal stress
    ...
    ax.plot(depth, value[:,nn_trans:4*nn_inter:nn],color="k", )     # ax.plot([depth[1],depth[end]],[3e-9, 3e-9] , "k", linestyle=":")
    ...
    ax3.plot(depth, value_1[:,nn_trans:4*nn_inter:nn],color="k", )    # plot every five steps
