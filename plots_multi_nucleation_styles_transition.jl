...
for index = EX                   # normal stress
    ...
    ax.plot(depth, value[:,mm:20:nn_trans],color="red", )        
    ...
    ax3.plot(depth, value_1[:,mm:20:nn_trans],color="blue", )      
...
figname = string(path, "_transition_representative_nucleation_style.png")
