...
#FILE = "20000.0_500.0_20_0.85_0.05_5"   # resolution testing


# Ru=1 test
FILE = "20000.0_5000.0_8_0.5_0.0_5.0"   # Ru number testing: no healing
...
stressdrop_2(taubefore[end,:], tauafter[end,:], FltX)    # the row is the number of event
