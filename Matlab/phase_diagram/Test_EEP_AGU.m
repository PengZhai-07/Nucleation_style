...
n_xxx = [log10(0.4), log10(300), log10(300), log10(0.4)];
n_yyy = [0.2,0.2,0.9,0.9];
...
set(h,"color","black")
% transition zone
plot([log10(0.4), log10(300)],[0.4,0.4], "k--")
plot([log10(0.4), log10(300)],[0.35,0.35], "k--")
%%
...
%%
xticks([log10(L*1000)])
xticklabels([0.4,0.5,0.6,0.8,1,1.2,1.6,2,2.5,3,4,5,6,8,10,12,16,20,25,30,40,50,63,80,100,125,160,200,250,300])
yticks([0.2:0.05:0.9])
...
text(log10(240),0.7,  ["Aseismic slip"],'Rotation',0,'FontSize',12)
...
set(gca,'TickDir', 'out')
%%
exportgraphics(gcf,'separate_nucleation_style_EEP_new_3.png','Resolution',600)