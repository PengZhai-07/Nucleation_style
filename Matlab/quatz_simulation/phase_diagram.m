...
set(gcf,'Position',[0 0 1000 600]);%左下角位置，宽高
...
% unit: m
L = [0.02, 0.025, 0.03,0.04, 0.05,0.06,0.08,0.1,0.12,0.16,0.2,0.25,0.3, 0.4, 0.5,0.6,0.8,1,1.2,1.6,2,2.5,3,4,5,6,8,10,12,16,20,25,30,40,50,63,80,100,125,160,200,250,300]*10^-3;  
...
scatter(log10(0.4),0.5, "r*")
scatter(log10(0.4),0.6, "r*")
scatter(log10(0.4),0.7, "r*")
scatter(log10(0.4),0.8, "r*")
scatter(log10(1),0.5, "r*")
scatter(log10(4),0.5, "r*")
% 
...
xticks([log10(L*1000)])
xticklabels([0.02, 0.025, 0.03,0.04, 0.05,0.06,0.08,0.1,0.12,0.16,0.2,0.25, 0.3, 0.4, 0.5,0.6,0.8,1,1.2,1.6,2,2.5,3,4,5,6,8,10,12,16,20,25,30,40,50,63,80,100,125,160,200,250,300])
yticks([0.2:0.05:0.9])
